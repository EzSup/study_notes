...
**Q: Як влаштований Outbox паттерн у Wolverine?** Повідомлення зберігаються в тій самій транзакції що і бізнес-дані. Фоновий relay процес читає не відправлені записи з outbox і доставляє їх в брокер. Це гарантує що або і зміни в БД, і повідомлення успішні, або обидва відкочуються.
